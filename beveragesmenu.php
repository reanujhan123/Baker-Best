...
$beveragessql = " SELECT * FROM product WHERE category_id = 1 ";
$beverages = $mysqli->query($beveragessql);
...
<body class="beverages">
    ...
    <div class="product_menu">
        ...
        <video autoplay muted loop id="bgVideo">
            <source src="Images/beveragevid.mp4" type="video/mp4">
        </video>
    </div>
    <div class="parent">
        <div class="glass">
            <div id="beveragesmenu">
