...
$cookiessql = " SELECT * FROM product WHERE category_id = 6 ";
$cookies = $mysqli->query($cookiessql);
...
<body class="cookies">
    ...
    <div class="product_menu">
        ...
        <video autoplay muted loop id="bgVideo">
            <source src="Images/cookievid.mp4" type="video/mp4">
        </video>
    </div>
    <div class="parent">
        <div class="glass">
    ...
    <div class="final-block">
        <div class="description">
            <img src="Images/logo5.png" style="width: 350px;height: 200px;" alt="">
            <p>Family-owned artisan cookies crafting fresh, delicious baked goods daily. From traditional breads
                to custom cakes, we bring warmth to your table.</p>
            <div class="socialmedia">
                <img src="Images/whatsapp.svg"
                    style="filter: brightness(0) saturate(100%) invert(65%) sepia(92%) saturate(454%) hue-rotate(59deg) brightness(93%) contrast(88%);"
                    alt="">
                <img src="Images/instagram.svg" style="    filter: invert(29%) sepia(97%) saturate(6155%) hue-rotate(302deg) brightness(91%) contrast(109%);
" alt="">
                <img src="Images/facebook.svg"
                    style="filter: brightness(0) saturate(100%) invert(47%) sepia(28%) saturate(5009%) hue-rotate(204deg) brightness(94%) contrast(88%);"
                    alt="facebook icon">
            </div>
        </div>
        <div class="contact">
